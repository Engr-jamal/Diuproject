...
--
-- Host: localhost
-- Generation Time: Apr 11, 2019 at 04:30 PM
...
(0, 'Office of the Director of Students\' Affairs is a professional body who are dedicated to the social, Psychological, ethical and cognitive development and well-being of all DIU Students. It also works collaboratively with respected faculty members\r\n\r\nto implement the universitys educational and developmental mission. In addition to it, the Office of the DSA looks after all club activities, foundation classes, orientation of newly admitted students, psychosocial support.');
...
CREATE TABLE `student_account` (
  ...
  `course_5` varchar(100) NOT NULL,
  `result_5` double NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `student_account` (`id`, `firstname`, `lastname`, `student_id`, `mobile`, `email`, `password`, `comment`, `TotalPaid`, `TotalPaidDue`, `CGPA`, `course_1`, `course_2`, `course_3`, `course_4`, `result_1`, `result_2`, `result_3`, `result_4`, `course_5`, `result_5`) VALUES
(4, 'muuse', 'sheikh', '1111111', 2147483647, 'jamalappdeveloper@gmail.com', 'c4ca4238a0b923820dcc509a6f75849b', '', 0, 0, 0, '', '', '', '', '', '', '', '', '', 0);
